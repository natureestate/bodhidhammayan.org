...
function HomeBangkokEnPage() {
  ...
  return (
    <>
      <SeoHead
        title="Knowing Buddha Foundation Meditation Room, Bangkok - Bodhi Dhammayan Retreat"
      ...
      />
      <Breadcrumb items={[{ label: "Home", href: "/en/homeen/" }, { label: "Bangkok" }]} />
      ...
      <section className="bg-white section-padding py-16 md:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-4 text-brand-text-secondary leading-relaxed">
            Anapanasati meditation taught by monks and assistant teachers.
            Includes recorded Dhamma talks by Ajahn Acharawadee Wongsakon. Available in Thai and English.
          </p>

          <div className="mt-8 rounded-xl border border-brand-gold-100 bg-brand-cream/50 p-6">
            <h3 className="font-serif text-lg font-semibold text-brand-dark">Contact Information</h3>
            <div className="mt-4 space-y-3 text-sm text-brand-text-secondary">
              <div className="flex items-start gap-3">
                ...
                <span>462/12 Soi On Nut 8, Sukhumvit 77 Rd., On Nut, Suan Luang, Bangkok 10250</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span>Tel: 02 117 4063, 02 117 4064</span>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="mt-8 space-y-4">
            {courses
              ...
              .map((course) => (
                <Link
                  key={course.id}
                  to={PAGE_URL_MAP["course-schedule"]?.en ?? "#"}
