...
function HomePhuketEnPage() {
  ...
  return (
    <>
      <SeoHead
        title="Bodhi Dhammayan Retreat Phuket - Meditation Center Thailand"
      ...
      <section className="bg-white section-padding py-16 md:py-20">
        <div className="mx-auto max-w-4xl">
          ...
          <p className="mt-4 text-brand-text-secondary leading-relaxed">
            For seekers of inner peace who want to learn proper meditation. Offering Anapanasati meditation
            courses including 1-day and 3-day (2 nights) programs.
          </p>
